...
import os
from V3R_pi0.utils import rank0_print
from einops import rearrange
import sys
sys.path.append('V3R_pi0/CUT3R')
...
class Cut3rSpatialTower(nn.Module):
    def __init__(self, spatial_tower, spatial_tower_cfg, delay_load=True):
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))  # V3R_pi0/multimodal_spatial_encoder
        project_root = os.path.abspath(os.path.join(script_dir, '..'))  # V3R_pi0
        dynamic_weights_path = os.path.join(project_root, 'spatial_encoder_checkpoint', 'cut3r_512_dpt_4_64.pth')
